...
public class setSessions extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel11.setBackground(new java.awt.Color(100, 149, 237));
        ...
        btn_addgId.setBackground(new java.awt.Color(0, 102, 0));
        btn_addgId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btn_addgId.setForeground(new java.awt.Color(255, 255, 255));
        btn_addgId.setText("Insert");
        btn_addgId.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        ...
        btn_updategId.setBackground(new java.awt.Color(0, 102, 255));
        btn_updategId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btn_updategId.setForeground(new java.awt.Color(255, 255, 255));
        btn_updategId.setText("Update");
        btn_updategId.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        btn_updategId.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
